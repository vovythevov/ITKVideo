...
#set (CTEST_SOURCE_DIRECTORY "${CTEST_SOURCE_DIRECTORY}/A2D2")
...
")
  ...
  if (res GREATER 0 OR force_build)
    ...
    ctest_configure(BUILD "${CTEST_BINARY_DIRECTORY}" SOURCE "C:")
    ctest_read_custom_files("${CTEST_BINARY_DIRECTORY}" SOURCE "C:")
